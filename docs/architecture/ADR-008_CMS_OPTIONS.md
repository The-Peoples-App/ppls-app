...
1. **Bronze (Pilot):** We will utilize a "Git-as-a-CMS" model. Staff will provide text changes in Markdown format within the repository, which we parse and bundle via the [SSG Engine Selection (ADR-015)](./ADR-015_SSG_ENGINE_SELECTION.md).
